...
class SafeRlFilterAgentSelfAttention():
    def __init__(self, base_name, params):
        ...
        self.online_net = OnlySelfAttention(config, self.actions_num).to(device=self._device)
        ...
        self.target_net = OnlySelfAttention(config, self.actions_num).to(device=self._device)
